...
TOOLS = [
    ...
    },
    {
        ...
        "description": "Create a new Quote in Salesforce linked to an opportunity. Pre-fills the Sales pricebook and uses the opportunity name as the default quote name. Returns the new Quote Id and QuoteNumber.",
        "inputSchema": {
            "type": "object",
            "properties": {
